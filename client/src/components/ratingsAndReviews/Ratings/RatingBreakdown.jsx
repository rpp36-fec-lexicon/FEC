...
class RatingBreakdown extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <div id="5" onClick={() => { this.props.filterRating(document.getElementById('5').id); }}>
        ...
        <div id="4" onClick={() => { this.props.filterRating(document.getElementById('4').id); }}>
        ...
        <div id="3" onClick={() => { this.props.filterRating(document.getElementById('3').id); }}>
        ...
        <div id="2" onClick={() => { this.props.filterRating(document.getElementById('2').id); }}>
        ...
        <div id="1" onClick={() => { this.props.filterRating(document.getElementById('1').id); }}>
